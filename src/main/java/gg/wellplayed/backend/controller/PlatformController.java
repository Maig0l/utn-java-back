...
public class PlatformController {
	...
	@PatchMapping("/{id}")
	public ApiResponse patch(@PathVariable("id") Long id, @RequestBody Platform platformReq) {
		return new ApiResponse("Platform updated partially", platformService.patch(id, platformReq));
	}
